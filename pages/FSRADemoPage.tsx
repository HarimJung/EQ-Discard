...
const DiscardAlertPage: React.FC = () => {
  return (
        ...
        <div className="max-w-[1700px] mx-auto py-8 px-4">
          <div className="bg-white shadow-xl rounded-lg overflow-hidden border border-gray-200">
            ...
            <div className="px-8 pt-8 pb-0">
              <h1 className="text-3xl font-bold text-[#002E72]">Discard Alert Investigation</h1>
              <p className="text-gray-500 mt-2">Comprehensive analysis of discard rates and claim patterns.</p>
            </div>
...
export default DiscardAlertPage;
